...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Changes to an existing order can be made as long as the order is still in 'processing' status. Please contact our team via email. If your order has been shipped, we cannot apply changes.",
  },
  {
  ...
  },
  {
    ...
    answer: "We accept MasterCard, Visa, American Express, PayPal, JCB Discover, Gift Cards, etc.",
  },
];
